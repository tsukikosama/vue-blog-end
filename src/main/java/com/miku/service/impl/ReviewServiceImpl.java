...
import com.miku.mapper.ReviewMapper;
import com.miku.mapper.UserMapper;
import com.miku.service.ReviewService;
...
import static com.miku.utils.RedisConstants.IS_LIKE;
...
//        List<Integer> ids = new ArrayList<>();
    ...
    @Override
    public Page<Review> listByPage(CommonQuery query) {
        LambdaQueryWrapper<Review> wrapper = new LambdaQueryWrapper<>();
