...
-- ----------------------------
INSERT INTO `cc_blog_like`
VALUES (2, 8, 13, '2025-04-29 17:03:00');
...
-- ----------------------------
INSERT INTO `cc_blog_type`
VALUES (1, 72, 8, '2025-05-08 14:56:27', 0, NULL, NULL);
INSERT INTO `cc_blog_type`
VALUES (2, 72, 5, '2025-05-08 14:56:27', 0, NULL, NULL);
INSERT INTO `cc_blog_type`
VALUES (3, 72, 2, '2025-05-08 14:56:27', 0, NULL, NULL);
INSERT INTO `cc_blog_type`
VALUES (4, 72, 6, '2025-05-08 14:56:27', 0, NULL, NULL);
INSERT INTO `cc_blog_type`
VALUES (5, 72, 3, '2025-05-08 14:56:27', 0, NULL, NULL);
INSERT INTO `cc_blog_type`
VALUES (6, 14, 3, '2025-05-08 15:21:25', 0, NULL, NULL);
INSERT INTO `cc_blog_type`
VALUES (7, 14, 2, '2025-05-08 15:21:25', 0, NULL, NULL);
INSERT INTO `cc_blog_type`
VALUES (8, 14, 6, '2025-05-08 15:21:25', 0, NULL, NULL);
INSERT INTO `cc_blog_type`
VALUES (9, 14, 5, '2025-05-08 15:21:25', 0, NULL, NULL);
INSERT INTO `cc_blog_type`
VALUES (10, 13, 6, '2025-05-08 15:26:53', 0, NULL, NULL);
INSERT INTO `cc_blog_type`
VALUES (11, 13, 5, '2025-05-08 15:26:53', 0, NULL, NULL);
INSERT INTO `cc_blog_type`
VALUES (12, 13, 3, '2025-05-08 15:26:53', 0, NULL, NULL);
INSERT INTO `cc_blog_type`
VALUES (13, 13, 7, '2025-05-08 15:26:53', 0, NULL, NULL);
...
-- ----------------------------
INSERT INTO `cc_tag`
VALUES (2, 'java', NULL, NULL);
INSERT INTO `cc_tag`
VALUES (3, 'c', NULL, NULL);
INSERT INTO `cc_tag`
VALUES (5, 'sppring', NULL, NULL);
INSERT INTO `cc_tag`
VALUES (6, 'redis', NULL, NULL);
INSERT INTO `cc_tag`
VALUES (7, 'pringboot', NULL, NULL);
INSERT INTO `cc_tag`
VALUES (8, 'vuex', NULL, NULL);
INSERT INTO `cc_tag`
VALUES (9, 'c++', NULL, NULL);
INSERT INTO `cc_tag`
VALUES (10, 'js', NULL, NULL);
INSERT INTO `cc_tag`
VALUES (11, 'html', NULL, NULL);
INSERT INTO `cc_tag`
VALUES (12, 'css', NULL, NULL);
INSERT INTO `cc_tag`
VALUES (13, 'test', NULL, NULL);
INSERT INTO `cc_tag`
VALUES (14, '日常', NULL, NULL);
...
(
    `id`          bigint                                                        NOT NULL COMMENT 'id',
    `label`       varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '标签名字',
    `value`       varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '标签值',
    `dict_id`     bigint                                                        NOT NULL COMMENT '字典值',
    `create_time` datetime                                                      NOT NULL COMMENT '创建时间',
    `update_time` datetime                                                      NOT NULL COMMENT '更新时间',
    `remark`      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
    PRIMARY KEY (`id`) USING BTREE
...
VALUES (1, 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', '', NULL, 'q', NULL, 1, 1, '2025-06-13 14:46:47', NULL,
        NULL);
